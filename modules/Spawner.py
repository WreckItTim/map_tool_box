...
def set_environment_vars(environment, path):
    ...
    environment.set_point(Data_Structure.Point(start.x, start.y, start.z, start.direction))
    environment.set_target(Data_Structure.Point(target.x, target.y, target.z, None))
